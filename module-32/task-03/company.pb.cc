...
PROTOBUF_CONSTEXPR Company::Company(
  ...
  , /*decltype(_impl_.create_year_)*/ 0

  , /*decltype(_impl_.foreign_)*/ false
} {}
...
const ::uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.create_year_),
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.adress_),
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.name_),
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.products_),
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.foreign_),
    3,
    0,
    1,
    2,
...
class Company::_Internal {
 public:
  ...
  static void set_has_create_year(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  ...
  static void set_has_products(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
...
Company::Company(const Company& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.create_year_) {}

    , decltype(_impl_.foreign_) {}
  };
  ...
  if ((from._impl_._has_bits_[0] & 0x00000001u) != 0) {
    _this->_impl_.adress_.Set(from._internal_adress(), _this->GetArenaForAllocation());
  }
  ...
  _impl_.products_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        _impl_.products_.Set("", GetArenaForAllocation());
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if ((from._impl_._has_bits_[0] & 0x00000004u) != 0) {
    _this->_impl_.products_.Set(from._internal_products(), _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.create_year_, &from._impl_.create_year_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.foreign_) -
    reinterpret_cast<char*>(&_impl_.create_year_)) + sizeof(_impl_.foreign_));
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _impl_.products_.ClearNonDefaultToEmpty();
    }
  }
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.create_year_, 0, static_cast<::size_t>(
        reinterpret_cast<char*>(&_impl_.foreign_) -
        reinterpret_cast<char*>(&_impl_.create_year_)) + sizeof(_impl_.foreign_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 8)) {
          _Internal::set_has_create_year(&has_bits);
          _impl_.create_year_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 34)) {
          auto str = _internal_mutable_products();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Company.products");
          #endif  // !NDEBUG
        } else {
          goto handle_unusual;
        }
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 40)) {
          ...
          _impl_.foreign_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
...
::uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        1, this->_internal_create_year(), target);
  }
  ...
  // optional string products = 4;
  if (cached_has_bits & 0x00000004u) {
    const std::string& _s = this->_internal_products();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(_s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
                                "Company.products");
  ...
  if (cached_has_bits & 0x00000010u) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        5, this->_internal_foreign(), target);
  }
...
void Company::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_products(from._internal_products());
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.create_year_ = from._impl_.create_year_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.foreign_ = from._impl_.foreign_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.adress_, lhs_arena,
                                       &other->_impl_.adress_, rhs_arena);
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.name_, lhs_arena,
                                       &other->_impl_.name_, rhs_arena);
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.products_, lhs_arena,
                                       &other->_impl_.products_, rhs_arena);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, _impl_.foreign_)
      + sizeof(Company::_impl_.foreign_)
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.create_year_)>(
          reinterpret_cast<char*>(&_impl_.create_year_),
          reinterpret_cast<char*>(&other->_impl_.create_year_));
}
